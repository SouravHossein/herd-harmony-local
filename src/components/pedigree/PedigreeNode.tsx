...
export const PedigreeNode = memo(({ data }: { data: PedigreeNodeData }) => {
  ...
  return (
    <Card className={`w-52 hover:shadow-lg transition-shadow cursor-pointer ${getGenderColor(data.goat.gender)}`}>
